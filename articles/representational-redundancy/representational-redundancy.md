...
event-sourced online multi-player games behind one web front, functional core / imperative shell, the domain's behavior defined in a formal YAML spec dialect per game.
