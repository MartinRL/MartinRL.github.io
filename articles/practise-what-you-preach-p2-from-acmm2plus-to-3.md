...
part: 2
tags: [linkedin, acmm, codehealth, codescene, evalops, kvissig]
---
...
ACMM v2 (Anderson, arXiv:2604.09388v2, 2026) extends v1 from five to six levels: L5 renamed to "Semi-Automated: The System Proposes, Humans Approve" (human as Operator), and a new L6 "Fully Autonomous" (human as Strategist, Hive as reference implementation). Levels 1-4, the ones this post moves between, are unchanged from v1.
...
Source docs: kvissig.se `docs/analysis/acmm.md` (both verdicts, superseded one kept inline), commit messages `3ac5a21`, `190491d`, `ab6d52e`; ACMM v2 summary in the ChronosHub vault (`strategy/ChronosHub-Engineering-Strategy/raw/ACMM-v2-level-6-2604.09388v2.md`).
