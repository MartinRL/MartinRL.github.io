---
title: "How Far Does the LLBLGen Model Go?"
...
Determinism, for the record, is solved on this stratum: Roslyn generators are required to be deterministic functions of their inputs. Same spec + same generator version + same compiler ⇒ same code. The LLBLGen posture is fully recoverable here.
...
**Thesis: apply the LLBLGen model per stratum, with the stratum boundary defined by what the spec determines.**
