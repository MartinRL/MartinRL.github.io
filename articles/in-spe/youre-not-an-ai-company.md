...
Tremendous output doesn't qualify you. I practice what I preach here. With AI I have extreme output: I recently built and deployed an online multi-player quiz (including content-creation pipelines), it's deployed and released, has lots of games, quite a few players. Output: check. Outcome: check, customers adopted, behavior changed, people play. Impact: negative. It cost tokens, I pay for hosting, domain, and analytics, and it cost my opportunity cost. (Making money was never the intent, but that's exactly the point.)

Output is easy. Outcome is hard. Impact is tremendously hard, and AI changes nothing about that hierarchy for traditional workflows, skillsets, and org. structures.
